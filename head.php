...
</script><link href="<?php $this->options->themeUrl('icon.css'); ?>" rel="stylesheet" type="text/css"/>
<link href="<?php $this->options->themeUrl('css.css'); ?>" rel="stylesheet" type="text/css"/>
<script type="text/javascript" src="<?php $this->options->themeUrl('js.js'); ?>"></script>