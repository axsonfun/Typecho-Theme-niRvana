...
</script><link href="<?php $this->options->themeUrl('').$this->options->dark(); ?>" rel="stylesheet" type="text/css"/><link href="<?php $this->options->themeUrl('icon.css'); ?>" rel="stylesheet" type="text/css"/><script language=javascript>window.onerror = function(){return true;}</script>